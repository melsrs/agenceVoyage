 ...
 */
final class Version20240430170400 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE form_reservation ADD CONSTRAINT FK_B5A3D944FB88E14F FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id)');
